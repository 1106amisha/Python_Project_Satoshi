...
def send_mail_django(request):
    ...
    message ="You\'re order is saved into our database.Thank you for purchasing from us..😊😊"
...
def updateItem(request):
    ...
    product = Products.objects.get(name=productId)
    print("-----------------------")
...
def register_user(request):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            customer, created  = Customer.objects.get_or_create(user=user, uname=username)
            ...
            return redirect("/ksi_store/login/")
